...
export const offersData: Offer[] = [
  {
    ...
    imgSrc: '/img/services/detailing-wnetrza.jpg',
    iconSrc: '/icons/services/detailing-wnetrza.png',
  },
  {
    slug: 'korekta-lakieru',
    title: 'Korekta lakieru',
    imgSrc: '/img/services/korekta-lakieru.jpg',
    iconSrc: '/icons/services/korekta-lakieru.png',
  },
  {
    slug: 'powloki-ochronne',
    title: 'Powłoki ochronne',
    imgSrc: '/img/services/powloki-ochronne.jpg',
    iconSrc: '/icons/services/powloki-ochronne.png',
  },
  {
    slug: 'usuwanie-wgniecen-pdr',
    title: 'Usuwanie wgnieceń (PDR)',
    imgSrc: '/img/services/usuwanie-wgniecen.jpg',
    iconSrc: '/icons/services/usuwanie-wgniecen.png',
  },
  {
    slug: 'renowacja-tapicerki-skorzanej',
    title: 'Renowacja tapicerki skórzanej',
    imgSrc: '/img/services/renowacja-tapicerki.jpg',
    iconSrc: '/icons/services/renowacja-tapicerki.png',
  },
  {
    slug: 'uslugi-tapicerskie',
    title: 'Usługi tapicerskie',
    imgSrc: '/img/services/uslugi-tapicerskie.jpg',
    iconSrc: '/icons/services/uslugi-tapicerskie.png',
  },
  {
    slug: 'wyciszanie-auta',
    title: 'Wyciszanie auta',
    imgSrc: '/img/services/wyciszanie-auta.jpg',
    iconSrc: '/icons/services/wyciszanie-auta.png',
  },
  {
    slug: 'uslugi-dodatkowe',
    title: 'Usługi dodatkowe',
    imgSrc: '/img/services/uslugi-dodatkowe.jpg',
    iconSrc: '/icons/services/uslugi-dodatkowe.png',
  },
];
